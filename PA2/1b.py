...
W_fc1 = tf.Variable(tf.truncated_normal([7*7*32,10],stddev = 0.1),name = "W3")
...
writer = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/3")
writer.add_graph(sess.graph)

writer2 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/4")
