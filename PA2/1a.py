...
W_fc1 = tf.Variable(tf.truncated_normal([14*14*32,10],stddev = 0.1),name = "W3")
b_fc1 = tf.Variable(tf.truncated_normal([10],stddev = 0.1),name = "B3")

h_pool1_flat = tf.reshape(h_pool1,[-1,14*14*32])
logits = tf.matmul(h_pool1_flat,W_fc1)+b_fc1
...
writer = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/5")
writer.add_graph(sess.graph)

writer2 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/6")
