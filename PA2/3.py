...
x_noise = tf.Variable(tf.truncated_normal([784],mean = 128,stddev = 64),name="gnoise")
...
writer = tf.summary.FileWriter("/home/psycholearner/projects/DL4CV-EE6132-/PA2/311")
writer.add_graph(sess.graph)

writer2 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/312")
writer2.add_graph(sess.graph)

writer3 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/313")
writer3.add_graph(sess.graph)

writer4 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/314")
writer4.add_graph(sess.graph)

writer5 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/315")
writer5.add_graph(sess.graph)

writer6 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/316")
writer6.add_graph(sess.graph)

writer7 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/317")
writer7.add_graph(sess.graph)

writer8 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/318")
writer8.add_graph(sess.graph)

writer9 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/319")
writer9.add_graph(sess.graph)

writer10 = tf.summary.FileWriter("/home/psycholearner/projects//DL4CV-EE6132-/PA2/320")
