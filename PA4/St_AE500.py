...
ew_1out = tf.reshape(ew_1,shape = [-1,784,500,1])
...
#writer = tf.summary.FileWriter("/home/psycholearner/projects/DL4CV-EE6132-/PA4/st5_train")
#writer.add_graph(sess.graph)

writer2 = tf.summary.FileWriter("/home/psycholearner/projects/DL4CV-EE6132-/PA4/st5_test")
writer2.add_graph(sess.graph)

saver = tf.train.Saver()

sess.run(tf.global_variables_initializer())
saver.restore(sess, "/home/psycholearner/projects//DL4CV-EE6132-/PA4/st_model5.ckpt")
'''
...
save_path = saver.save(sess, "/home/psycholearner/projects/DL4CV-EE6132-/PA4/st_model5.ckpt")
'''
test_batch = mnist.test.next_batch(3)
noisy_factor = 0.9
noisy_batch = test_batch[0] + noisy_factor*np.random.randn(*test_batch[0].shape)
s2 = sess.run(merged_summary,feed_dict = {x:noisy_batch})
