...
#writer = tf.summary.FileWriter("/home/psycholearner/projects/DL4CV-EE6132-/PA4/noise_train")
#writer.add_graph(sess.graph)

writer2 = tf.summary.FileWriter("/home/psycholearner/projects/DL4CV-EE6132-/PA4/noise_test")
writer2.add_graph(sess.graph)

saver = tf.train.Saver()

#sess.run(tf.global_variables_initializer())
saver.restore(sess, "/home/psycholearner/projects//DL4CV-EE6132-/PA4/noise_model3.ckpt")
'''
...
save_path = saver.save(sess, "/home/psycholearner/projects/DL4CV-EE6132-/PA4/noise_model3.ckpt")
'''
